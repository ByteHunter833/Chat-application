...
class ZegoRingtone {
  ...
  AudioContext get defaultAudioContext => AudioContext(
        iOS: AudioContextIOS(
          ...
          // `ambient` already coexists with other audio on iOS. Explicitly
          // adding `mixWithOthers` is invalid in newer audioplayers releases
          // and triggers an assertion during call invitation ringtone setup.
          options: const {},
        ),
